...
#'   \item \strong{bottom_oxygen_mlpl}: Bottom dissolved oxygen recorded at the gear, in ml per L.
#'   \item \strong{bottom_salinity_psu}: Bottom salinity recorded at the gear, in practical salinity units.
